...
metadata {
    ...
    tiles(scale: 2) {
        ...
        standardTile("weatherIcon", "device.weatherIcon", decoration: "flat", width: 2, height: 2) {
            state "chanceflurries", icon:"st.custom.wuk.chanceflurries", label: ""
            state "chancerain", icon:"st.custom.wuk.chancerain", label: ""
            state "chancesleet", icon:"st.custom.wuk.chancesleet", label: ""
            state "chancesnow", icon:"st.custom.wuk.chancesnow", label: ""
            state "chancetstorms", icon:"st.custom.wuk.chancetstorms", label: ""
            state "clear", icon:"st.custom.wuk.clear", label: ""
            state "cloudy", icon:"st.custom.wuk.cloudy", label: ""
            state "flurries", icon:"st.custom.wuk.flurries", label: ""
            state "fog", icon:"st.custom.wuk.fog", label: ""
            state "hazy", icon:"st.custom.wuk.hazy", label: ""
            state "mostlycloudy", icon:"st.custom.wuk.mostlycloudy", label: ""
            state "mostlysunny", icon:"st.custom.wuk.mostlysunny", label: ""
            state "overcast", icon:"st.custom.wuk.partlycloudy", label: ""
	    state "partlycloudy", icon:"st.custom.wuk.partlycloudy", label: ""
            state "partlysunny", icon:"st.custom.wuk.partlysunny", label: ""
            state "rain", icon:"st.custom.wuk.rain", label: ""
            state "sleet", icon:"st.custom.wuk.sleet", label: ""
            state "snow", icon:"st.custom.wuk.snow", label: ""
            state "sunny", icon:"st.custom.wuk.sunny", label: ""
            state "tstorms", icon:"st.custom.wuk.tstorms", label: ""
            state "cloudy", icon:"st.custom.wuk.cloudy", label: ""
	    state "partlycloudy", icon:"st.custom.wuk.partlycloudy", label: ""
            state "nt_chanceflurries", icon:"st.custom.wuk.nt_chanceflurries", label: ""             
	    state "nt_chancerain", icon:"st.custom.wuk.nt_chancerain", label: ""
            state "nt_chancesleet", icon:"st.custom.wuk.nt_chancesleet", label: ""
            state "nt_chancesnow", icon:"st.custom.wuk.nt_chancesnow", label: ""
            state "nt_chancetstorms", icon:"st.custom.wuk.nt_chancetstorms", label: ""
            state "nt_clear", icon:"st.custom.wuk.nt_clear", label: ""
            state "nt_cloudy", icon:"st.custom.wuk.nt_cloudy", label: ""
            state "nt_flurries", icon:"st.custom.wuk.nt_flurries", label: ""
            state "nt_fog", icon:"st.custom.wuk.nt_fog", label: ""
            state "nt_hazy", icon:"st.custom.wuk.nt_hazy", label: ""
            state "nt_mostlycloudy", icon:"st.custom.wuk.nt_mostlycloudy", label: ""
            state "nt_mostlysunny", icon:"st.custom.wuk.nt_mostlysunny", label: ""
            state "nt_overcast", icon:"st.custom.wuk.nt_partlycloudy", label: ""
	    state "nt_partlycloudy", icon:"st.custom.wuk.nt_partlycloudy", label: ""
            state "nt_partlysunny", icon:"st.custom.wuk.nt_partlysunny", label: ""
            state "nt_sleet", icon:"st.custom.wuk.nt_sleet", label: ""
            state "nt_rain", icon:"st.custom.wuk.nt_rain", label: ""
            state "nt_sleet", icon:"st.custom.wuk.nt_sleet", label: ""
            state "nt_snow", icon:"st.custom.wuk.nt_snow", label: ""
            state "nt_sunny", icon:"st.custom.wuk.nt_sunny", label: ""
            state "nt_tstorms", icon:"st.custom.wuk.nt_tstorms", label: ""
            state "nt_cloudy", icon:"st.custom.wuk.nt_cloudy", label: ""
            state "nt_partlycloudy", icon:"st.custom.wuk.nt_partlycloudy", label: ""
        }
	...
	multiAttributeTile(name:"temperature2", type:"generic", width: 1, height: 1, canChangeIcon: false){
		tileAttribute("device.temperature", key: "PRIMARY_CONTROL") {
               		attributeState("temperature",label:'${currentValue}°',
				        icon:"https://raw.githubusercontent.com/castlecole/customdevices/master/weather-icon180.png",
					backgroundColors:[
					[value: 32, color: "#153591"],
					[value: 44, color: "#1e9cbb"],
					[value: 59, color: "#90d2a7"],
